		...
		for msg in reversed(msgs[0].split(' ')):
			...
			if ret == 'OK':
				...
				try:
					...
					print "Error: \"Make sure your operating system is compliant with gmreader (i.e. mac osx, linux, windows). If linux or windows, you must have espeak install on your machine.\""
					sys.exit(1)
def main():
